...
for step in range(n_steps):
    ...
    error = r + discount_rate * np.max(Q[s_[0], s_[1]]) - Q[req_type, num_empty_slots, a]
...
print('rwd_avg = %.4f' % (rwd_avg * sum(env.req_val)) )
...
plot_history("rwd", rwd_history, True)
